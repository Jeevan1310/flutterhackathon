  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                child: ListTile(
                    ...
                    leading: res.complete ? Icon(Icons.check_box) : Icon(Icons.check_box_outline_blank),
                    onTap: () {
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => AddTodo())),
        tooltip: 'Add todo',
